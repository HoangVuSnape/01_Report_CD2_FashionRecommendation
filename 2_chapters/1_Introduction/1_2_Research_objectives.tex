...
\begin{enumerate}
    ...
    \item Extract visual representation embeddings using convolutional neural networks (MobileNetV2) and vision-language foundation models (CLIP), and textual representations using BERT dense embeddings (with TF-IDF lexical similarity for the CombiGCN graph).
