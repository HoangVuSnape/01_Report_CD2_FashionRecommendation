...
\subsection{Encoder Comparison (RQ1)}
...
\subsection{Fusion Strategy Comparison (RQ2)}
...
\begin{tabular}{lcccc}
\hline
\textbf{Model} & \textbf{img\_only} & \textbf{tfidf} & \textbf{multimodal} & \textbf{multimodal\_attention} \\ \hline
...
\subsection{Model Comparison (RQ3 \& RQ4)}
